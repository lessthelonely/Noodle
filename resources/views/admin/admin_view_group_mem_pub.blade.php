                ...
                <div class="row" style="width: auto;height: auto;max-height: 450px;margin-bottom: 70px;">
                    <div class="col" style="width: auto;height: auto;max-height: 450px;padding: 0px;margin-bottom: 0px;">
                        ...
                        <form method="post" action="{{route('delete_group', ['id'=>$group->id])}}">
                            @csrf
                            @method('delete')
                            <button class="btn btn-primary btn" id="group-member" type="submit" style="padding: 0px;margin: 0px;position: absolute;top: 465px;left: 70%;" data-can-join="false"> Apagar Grupo
                            </button>
                        </form>
