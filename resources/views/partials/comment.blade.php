<div class="comments align-self-end" data-id="{{$comment->id}}" data-post-id="{{$comment->idpublicacao}}">
    <header class="d-flex flex-row align-items-center" style="margin-bottom: 5px; margin-left: 5px; margin-top: 5px;">
        <a style="color: #0c1618; text-decoration: none" href="{{ route('show_profile', ['id' => $comment->idutilizador]) }}">
            ...
            <a href="{{ route('show_profile', ['id' => $comment->idutilizador]) }}" style="color: #0c1618; text-decoration: none;">
            ...
            <div class="footer">
                ...
                <a class="delete-com" href="#" style="text-decoration: none;">
                    <i title="Apagar Comentário" class="fa fa-trash"></i>
                </a>
                @endif
                @endif
